...
const EventItem = ({ event, isActive, isNew, onSelect }) => {
  ...
  return (
    ...
    >
      ...
      <span className="event-type">{event.type || 'New Event'}</span>
  ...
  return (
    <div className="event-panel">
      <div className="panel-header">
        <h2>
          <i className="fas fa-calendar-check"></i> Active Events
          {isCreatingNew && (
        ...
        <p className="subtitle">Select an event to view details</p>
      </div>
